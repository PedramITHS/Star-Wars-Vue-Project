        ...
        <div class="showItems">
            <div class="d-flex justify-content-center">
                <b-button-group id="deskDisp">
                    ...
                    <b-button class="x-btn" size="lg" @click="fetchCharacters" style="background-color: #222226">
                        Show characters</b-button>
                    <!-- Knapp för att visa planeter -->

                    <b-button class="x-btn" size="lg" @click="fetchPlanets" style="background-color: #222226">Show Planets
                    </b-button>

                    <!-- Knapp för att visa starships -->
                    <b-button class="x-btn" size="lg" @click="fetchStarships" style="background-color: #222226">Show
                        Starships
                    </b-button>

                    <!-- Knapp för att visa arter -->
                    <b-button class="x-btn" size="lg" @click="fetchSpecies" style="background-color: #222226">Show Species
                    </b-button>

                    <!-- Knapp för att visa filmer -->
                    <b-button class="x-btn" size="lg" @click="fetchFilms" style="background-color: #222226">Show Films
                    </b-button>
                </b-button-group>
            </div>
            <div class="allCards">
